	...
	public class StaticVideo : BaseBehaviour {
		...
		*/
		protected void Start()
		{
			...
			if (videoClip != null) videoController.PlayClip(videoClip);
			//else videoController.PlayURL(videoURL);
			else videoController.PlayURL(System.IO.Path.Combine(Application.streamingAssetsPath, videoURL));

			this.GetComponent<VideoPlayer>().aspectRatio = VideoAspectRatio.Stretch;
		}
